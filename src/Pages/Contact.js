...
<section class="text-gray-400 bg-gray-900 body-font relative pt-5">
  <div class="container px-5 py-5 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-white font-hahmlet">Let's Connect</h1>
    </div>
    {status && renderAlert()}
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        <div class="p-2 w-1/2">
          <div class="relative">
            <label for="name" class="leading-7 text-sm text-gray-400 font-lora">Name</label>
        ...
        <div class="p-2 w-1/2">
          <div class="relative">
            <label for="email" class="leading-7 text-sm text-gray-400 font-lora">Email</label>
        ...
        <div class="p-2 w-full">
          <div class="relative">
            <label for="message" class="leading-7 text-sm text-gray-400 font-lora">Message</label>
        ...
        <div class="p-2 w-full">
          <button type='submit' value="send" class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg font-lora">Send</button>
        </div>
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
          <a href={"https://mail.google.com/mail/?view=cm&fs=1&to=sandeepbudha.sb@gmail.com"} target="_blank" rel="noreferrer" class="text-indigo-400 font-hahmlet">sandeepbudha.sb@gmail.com</a>
          <p class="leading-normal font-hahmlet">Kathmandu, Nepal</p>
        </div>
      </div>
    </div>
  </div>
