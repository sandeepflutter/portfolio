      ...
      <a href={som} target="_blank" rel="noreferrer">
        <div class="flex relative">
          ...
          <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100 duration-500">
            ...
            <p class="leading-relaxed text-justify font-crimson">Samrajya is an online shopping application that is dedicated to serving its users by delivering the essential products right to their front doors.</p>
          </div>
        </div>
        </a>
      </div>
