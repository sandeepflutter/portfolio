...
export default function Services() {
  ...
  return (
    <><div class="sm:hidden">
      ...
      </div><ul class="hidden text-sm font-medium text-center text-gray-500 rounded-lg divide-x divide-gray-200 shadow sm:flex dark:divide-gray-700 dark:text-gray-400">
              <li class="w-full">
